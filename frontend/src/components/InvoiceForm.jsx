...
const InvoiceForm = () => (
  <form className="">
    ...
    <div className="grid grid-cols-2 gap-4 mb-8">
      ...
      <div className="flex flex-col">
        <label className="font-medium mb-1">Office/Vessel <span className="text-red-500">*</span></label>
        <select className="border rounded px-2 py-1"><option>INCH-MT HARI PRAKASH (vessel)</option></select>
      </div>
      <div className="flex flex-col">
        <label className="font-medium mb-1">Department <span className="text-red-500">*</span></label>
      ...
      <div className="flex flex-col">
        <label className="font-medium mb-1">Due Date (Leave empty to auto generate)</label>
        <input type="date" className="border rounded px-2 py-1" />
      </div>
      <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        <label className="font-medium mb-1">Corresponding Proforma Invoice</label>
        <input type="text" className="border rounded px-2 py-1" />
      </div>
      {/* Row 3 */}
      <div className="flex flex-col">
      ...
      <div className="flex flex-col col-span-2">
        <label className="font-medium mb-1">Cargo Type</label>
        <input type="text" className="border rounded px-2 py-1" />
      </div>
      <div className="flex flex-col">
